...
import { IWartungsUndStoerungsmeldungArtikelProps } from './components/IWartungsUndStoerungsmeldungArtikelProps';
...
export default class WartungsUndStorungsmeldungArtikelWebPart extends BaseClientSideWebPart<IWartungsUndStorungsmeldungArtikelWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IWartungsUndStoerungsmeldungArtikelProps> = React.createElement(
      WartungsUndStorungsmeldungArtikel,
      {
