...
var SPService = /** @class */ (function () {
    ...
    SPService.prototype.getSPListData = function (listName) {
        var _this = this;
        var options = {
            day: '2-digit',
            month: '2-digit',
        ...
        var localDateTime = new Date().toISOString();
        var url = "https://bernerfachhochschule.sharepoint.com/sites/mybfh-Wartungs-und-Stoerungsmeldungen-de/_api/web/lists/GetByTitle('" + listName + "')/items?" +
            ...
            return __generator(this, function (_a) {
                this._context.spHttpClient.get(url, SPHttpClient.configurations.v1)
                    ...
                    rawResponse.json()
                        ...
                        jsonResponse.value.map(function (spItem) {
                            var date = new Date(spItem.StartDateTime);
